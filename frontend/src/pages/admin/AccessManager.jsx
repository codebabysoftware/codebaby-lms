...
export default function AccessManager() {
  ...
  const fetchStudents = async () => {
    try {
      const res = await fetch(`${import.meta.env.VITE_API_URL}/api/admin/students/`, { headers: { 'Authorization': `Bearer ${localStorage.getItem('access_token')}` }});
  ...
  const fetchCourses = async () => {
    try {
      const res = await fetch(`${import.meta.env.VITE_API_URL}/api/courses/`, { headers: { 'Authorization': `Bearer ${localStorage.getItem('access_token')}` }});
  ...
  const fetchLessons = async () => {
    try {
      const res = await fetch(`${import.meta.env.VITE_API_URL}/api/lessons/`, { headers: { 'Authorization': `Bearer ${localStorage.getItem('access_token')}` }});
  ...
  const fetchEnrollments = async () => {
    try {
      const res = await fetch(`${import.meta.env.VITE_API_URL}/api/enrollments/`, { headers: { 'Authorization': `Bearer ${localStorage.getItem('access_token')}` }});
  ...
  const fetchLessonAccess = async () => {
    try {
      const res = await fetch(`${import.meta.env.VITE_API_URL}/api/lesson-access/`, { headers: { 'Authorization': `Bearer ${localStorage.getItem('access_token')}` }});
  ...
  const handleRevokeEnrollment = async (id) => {
    ...
    try {
      const res = await fetch(`${import.meta.env.VITE_API_URL}/api/enrollments/${id}/`, { method: 'DELETE', headers: { 'Authorization': `Bearer ${localStorage.getItem('access_token')}` } });
  ...
  const handleRevokeLesson = async (id) => {
    ...
    try {
      const res = await fetch(`${import.meta.env.VITE_API_URL}/api/lesson-access/${id}/`, { method: 'DELETE', headers: { 'Authorization': `Bearer ${localStorage.getItem('access_token')}` } });
